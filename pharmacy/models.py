...
from config.settings import _IMAGE_VALIDATORS
...
class Medicine(models.Model):
    ...
    '''
    image = models.ImageField(upload_to="medicine_images/", blank=True, null=True, validators=_IMAGE_VALIDATORS)
    ...
    def save(self, *args, **kwargs):
        ...
        self.selling_price_after_discount = discounted.quantize(Decimal("0.01"), rounding=ROUND_HALF_UP)
