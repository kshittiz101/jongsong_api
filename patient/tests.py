...
from accounts.models import AdminProfile, Designation
from core.constants.blood_groups import BloodGroup
from core.constants.genders import Gender
from core.constants.patient_types import PatientType
...
class PatientProfileApiTests(APITestCase):
    ...
    def test_admin_can_list_patient_profiles(self):
        ...
        res = self.client.get("/api/admin/patient-profiles/", format="json")
        self.assertEqual(res.status_code, 200, res.data)
    ...
    def test_patient_can_get_me(self):
        ...
        res = self.client.get("/api/admin/patient-profiles/me/", format="json")
        self.assertEqual(res.status_code, 200, res.data)
    ...
    def test_patient_gets_404_for_other_profile_pk(self):
        ...
        self._jwt(self.patient_user)
        res = self.client.get(
            f"/api/admin/patient-profiles/{other_profile.pk}/", format="json"
        )
